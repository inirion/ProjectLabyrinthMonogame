...
namespace LabyrinthGameMonogame.GameFolder.Enteties
{
    class Cube
    {
        ...
        public Cube(GraphicsDevice graphic, Vector3 size, Vector3 position, float scale)
        {
            Scale = scale;
        ...
        private void BuildVerticles(Vector3 size, Vector3 position)
        {
            ...
            Vector2 textureTopLeft = new Vector2(Scale * size.X, 0.0f * size.Y);
            Vector2 textureTopRight = new Vector2(0.0f * size.X, 0.0f * size.Y);
            Vector2 textureBottomLeft = new Vector2(Scale * size.X, Scale * size.Y);
            Vector2 textureBottomRight = new Vector2(0.0f * size.X, Scale * size.Y);
